...
Last audit: cycle 38. Source: `dist/*.html` + `src/styles/layout.min.css` vs `mirror/mr`.
...
| PDP `/products/cv2` | 52/52 | 22/22 | (selector) | 100 |
| `/contact` | 49/49 | 22/22 | (selector) | 100 |
| `/downloads` | 46/46 | 22/22 | (selector) | 100 |
