...
const CHROME_CLASSES = [
  ...
  "frame-type-sitereinhausen_teaserproduct",
...
const pages = [
  ...
  { id: "/products", route: "products", mr: path.join(root, "mirror/mr/portfolio.html"), extra: ["introtext", "h1ToIntro", "subnavi-big", "subnavi-big-button", "wordcloud-container", "wordcloud", "js-wordcloud-item", "product-list-plugin", "teaser-module", "teaser_element", "textteaser-gradient", "frame-type-sitereinhausen_teaser", "wordcloud-items", "tab-navi-solutions", "noHit"] },
  { id: "/products/oltc", route: "products/oltc", mr: mrOltc, extra: ["product-list-plugin", "tabelle", "table-gradient", "table-white", "table-grey", "product-box", "product-keyfacts", "stage", "introtext", "breadcrumb", "subline", "frame-type-sitereinhausen_stage", "frame-type-sitereinhausen_introtext", "frame-type-sitereinhausen_table", "text-module", "text-wrapper", "cta-outline", "textmedia", "frame-type-sitereinhausen_textmedia", "teaser-module", "frame-type-sitereinhausen_teaser", "text-media-images", "modellSwiperGallery", "media-50-right-3-2"] },
  { id: "/products/octc", route: "products/octc", mr: mrOltc, extra: ["product-list-plugin", "tabelle", "table-gradient", "product-box", "introtext", "subline", "text-module", "frame-type-sitereinhausen_table", "frame-type-sitereinhausen_stage", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/products/accessories", route: "products/accessories", mr: mrOltc, extra: ["product-list-plugin", "tabelle", "table-gradient", "product-box", "introtext", "subline", "text-module", "frame-type-sitereinhausen_table", "frame-type-sitereinhausen_stage", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/products/oltc-oil", route: "products/oltc-oil", mr: mrOltc, extra: ["product-list-plugin", "tabelle", "table-gradient", "product-box", "introtext", "subline", "text-module", "frame-type-sitereinhausen_table", "frame-type-sitereinhausen_stage", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/products/cv2", route: "products/cv2", mr: mrPdp, extra: ["product-detail-wrapper", "keyfacts", "keyfacts-list", "keyfact-headline", "download-center", "downloadcenter-rows", "downloadItem", "breadcrumb", "product-related-products", "teaser_products", "width-small", "icon-plus", "collapse-mobile-spec-number", "product-registers-container", "accordion", "accordion-js", "nav-pills", "tab-content", "tab-pane", "card-header", "tabelle", "table-wrapper", "download-name", "download-icon", "show-more-keyfacts-js", "show-less-keyfacts-js", "product-related-services", "product-detail-btn", "teaser-module", "two-column", "cta-outline", "intro", "frame-type-sitereinhausen_teaser", "teaser_newsimpulse", "newsimpulse-swiper", "icon-placeholder"] },
  { id: "/contact", route: "contact", mr: path.join(root, "mirror/mr/contact.html"), extra: ["tx-powermail", "powermail_form", "powermail_fieldset", "powermail_input", "powermail_textarea", "powermail_submit", "cta-gradient", "powermail_label", "powermail_field", "frame-type-powermail_pi1", "placholder", "breadcrumb", "contactfinder", "subnavi-big", "subnavi-big-button", "contact-results-wrapper", "contact-results", "contact-teaser", "contact-person", "contact-info", "contact-info-name", "introtext", "h1ToIntro", "powermail_select", "powermail_fieldwrap_type_select", "powermail_fieldwrap_country", "teaser-module", "frame-type-sitereinhausen_teaser", "frame-type-list", "powermail_fieldwrap_namevorname", "powermail_fieldwrap_e_mail", "powermail_fieldwrap_firma", "powermail_fieldwrap_anrede", "powermail_fieldwrap_ihrenachricht", "powermail_fieldwrap_telefon", "textarea-length"] },
  { id: "/downloads", route: "downloads", mr: path.join(root, "mirror/mr/downloadcenter.html"), extra: ["download-center", "downloadcenter-rows", "downloadItem", "dc-filter-container", "downloadCenter-filter", "downloadcenter-select-area", "breadcrumb", "introtext", "h1ToIntro", "subnavi-big", "subnavi-big-button", "downloadTabs", "tab-content", "downloadCenterInputWrapper", "kesearch_searchbox", "ke_search_sword_search", "download-name", "download-icon", "download-link", "icon", "teaser-module", "frame-type-sitereinhausen_teaser", "frame-type-list", "dc-select", "icon-placeholder"] },
  { id: "/about", route: "about", mr: path.join(root, "mirror/mr/company.html"), extra: ["numbers-module", "number-headline", "number-number", "number-overline", "number-label", "numbers", "breadcrumb", "text-module", "text-wrapper", "frame-type-sitereinhausen_text", "headline", "introtext", "h1ToIntro", "teaser_newsimpulse", "newsimpulse-swiper", "frame-type-sitereinhausen_articlenumbers", "frame-type-sitereinhausen_teasernewsimpulse", "textmedia", "text-media", "text-media-text", "frame-type-sitereinhausen_textmedia", "quote", "quote-text", "quote-content", "author", "frame-type-sitereinhausen_articlequote", "teaser-module", "frame-type-sitereinhausen_teaser", "text-media-images", "modellSwiperGallery", "media-50-right-3-2", "media-description"] },
  { id: "/news", route: "news", mr: path.join(root, "mirror/mr/impulses.html"), extra: ["teaser_articles", "article-main-area", "blue-teaser", "article-slider-area", "swiper-articles", "articleWrapper", "breadcrumb", "introtext", "h1ToIntro", "articleImage", "teaser-module", "teaser_element", "textteaser-gradient", "frame-type-sitereinhausen_teaser", "frame-type-sitereinhausen_topicteaser", "anim-overlay", "image-placeholder", "news-overview-item-text", "product-title", "link-download"] },
  { id: "/search", route: "search", mr: path.join(root, "mirror/mr/search.html"), extra: ["tx-kesearch-pi1", "kesearch_searchbox", "kesearchbox", "ke_search_sword_search", "frame-type-ke_search_pi1", "frame-type-ke_search_pi2", "searchbox-grid", "resetbutt", "resetButton", "submitbutt", "resultCounterInfo", "countedResults", "searchWord", "kesearch_results", "kesearch_pagebrowser_bottom", "load-more", "result-list-item", "result-title", "result-title-page", "result-teaser", "result-number", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/404", route: "404", mr: path.join(root, "mirror/mr/404.html"), extra: ["textmedia-parallax", "color-blue", "parallax-bg", "media-content", "copy-content", "cta-outline", "frame-type-sitereinhausen_mediaparallax", "image-bg", "gradient-bg", "text-module", "frame-type-sitereinhausen_text", "teaser-module"] },
  { id: "/legal/imprint", route: "legal/imprint", mr: path.join(root, "mirror/mr/imprint.html"), extra: ["text-module", "bg-white", "headline", "text-wrapper", "frame-type-sitereinhausen_text", "introtext", "h1ToIntro", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/legal/privacy", route: "legal/privacy", mr: path.join(root, "mirror/mr/imprint.html"), extra: ["text-module", "bg-white", "headline", "text-wrapper", "frame-type-sitereinhausen_text", "introtext", "h1ToIntro", "teaser-module", "frame-type-sitereinhausen_teaser"] },
  { id: "/news/chvt-longdong-800kv", route: "news/chvt-longdong-800kv", mr: path.join(root, "mirror/mr/impulse-article.html"), extra: ["articleIntro", "articleIntro-image", "blueBox", "article-text", "article-text-left", "frame-type-sitereinhausen_articleintro", "box-left", "media-100-16-6", "quote", "quote-text", "quote-content", "author", "frame-type-sitereinhausen_articlequote", "numbers-module", "number-number", "frame-type-sitereinhausen_articlenumbers", "teaser-module", "frame-type-sitereinhausen_teaser"] },
];
